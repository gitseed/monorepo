...
locals {
  upstreams = yamldecode(file("${path.module}/../../ai-sandbox/container/upstreams.yml"))

  # AWS regions from regions.json (generated by ai-sandbox/sigv4/tofu/aws_regions.tf
