...
main() {
    ...
    # Per-session subnet with a static IP for dnsmasq: the sandbox's dns:
    # needs a literal IP at container create time. Probe existing docker
    # networks so concurrent sessions don't collide.
    pick_subnet() {
        local used octet
    ...
    export SANDBOX_DNSMASQ_IP="$net.2"     # .1 is the gateway
